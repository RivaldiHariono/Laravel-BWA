...
@section('content')
    <div class="card">
        <div class="card-header">
            <strong>Add Product Picture</strong>
        </div>
        ...
        <div class="card-body">
            <form action="{{ route('productGallery.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label for="is_default" class="form-control-label">Default Product</label>
                    <br>
                    <label for="">
                ...
                <div class="form-group">
                    <button class="btn btn-primary btn-block" type="submit">Add Product Picture</button>
                </div>
